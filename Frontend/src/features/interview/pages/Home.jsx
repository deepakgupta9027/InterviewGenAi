...
const Home = () => {
    ...
    const handleGenerateReport = async () => {
        ...
        if (data && data._id) {
            ...
            alert("There was an error generating your strategy. Please try again.")
        }
    }
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume'>
                                ...
                                <p className='dropzone__subtitle'>{fileName ? 'File attached successfully' : 'PDF or DOCX (Max 5MB)'}</p>
                                <input 
                                    ref={resumeInputRef} 
                                    hidden 
                                    type='file' 
